...
const fireWorker = async (req: Request<{id: string, workerId: string}>, res: Response<string>) => {
  try{
    ...
    await WorkerModel.findOneAndUpdate({_id:workerId}, {$set: {business: null}}).exec();
